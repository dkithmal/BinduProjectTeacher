...
public:
    ...
    void setupUi(QWidget *DownloadFile)
    {
        ...
        tWSelectHomeWork->setGeometry(QRect(390, 40, 361, 371));
        ...
        gBSelectStudent->setGeometry(QRect(10, 420, 351, 91));
        ...
        tWSelectClass->setGeometry(QRect(10, 40, 351, 371));
        ...
        label_3->setGeometry(QRect(390, 10, 141, 21));
