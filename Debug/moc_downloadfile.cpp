...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DownloadFile_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 45, 21)
    ...
    "DownloadFile\0on_tWSelectClass_clicked\0"
    "\0index\0on_pBDownload_clicked\0"
};
...
const QMetaObject DownloadFile::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DownloadFile.data,
      qt_meta_data_DownloadFile,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DownloadFile.stringdata))
